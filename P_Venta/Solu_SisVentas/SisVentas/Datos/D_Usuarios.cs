    ...
    public class D_Usuarios
    {
        public DataTable Login_us(string cLogin_us, string cPassword)
        {
            ...
            try
            {
                ...
                MySqlCommand Comando = new MySqlCommand("ups_login_us", SqlCon);
        ...
        public DataTable Listado_us(string cTexto)
        {
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConexion();
                MySqlCommand Comando = new MySqlCommand("ups_listado_us", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable Listado_ru()
        {
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConexion();
                MySqlCommand Comando = new MySqlCommand("ups_listado_ru", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
                SqlCon.Open();
                Resultado = Comando.ExecuteReader();
                Tabla.Load(Resultado);
        ...
        public string Guardar_us(int nOpcion, E_Usuarios oPro)
        {
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConexion();
                MySqlCommand Comando = new MySqlCommand("ups_guardar_us", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
        ...
        public string Activo_us(int nCodigo_us)
        {
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConexion();
                MySqlCommand Comando = new MySqlCommand("ups_activo_us", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("nCodigo_us", MySqlDbType.Int32).Value = nCodigo_us;
                SqlCon.Open();

                Rpta = Comando.ExecuteNonQuery() >= 1 ? "OK" : "No se pudo realizar la modificacion...";
